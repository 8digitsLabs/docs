...
<Card title="Earning points" icon="chart-line" href="/concepts/tokens#points">
  Earned by using the app. Trading OKA or IOKA does not count.
</Card>

## Points

Points come from using the app. They decide how the community incentive is split. Buying or selling OKA or IOKA earns nothing here.

Four things count, and all four are about stock trades in the app:

- **Volume traded.** The stocks and ETFs you buy and sell. Not volume in the OKA or IOKA pools.
...
A hook and a bot make the market on the index pool, on top of the 2% fee.
...
Making the market earns fees. They go to the growth fund, and they pay for developing the app.
