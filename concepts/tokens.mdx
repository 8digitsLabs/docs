...
%%{init: {"theme":"base","themeVariables":{
  "primaryColor":"#e8564f","primaryTextColor":"#ffffff","primaryBorderColor":"#e8564f",
  "lineColor":"#8a8f98","secondaryColor":"#ff8d80","tertiaryColor":"#2a2a2a",
  "fontSize":"15px"}}}%%
flowchart LR
...
```mermaid
%%{init: {"theme":"base","themeVariables":{
  "pie1":"#e8564f","pie2":"#ff8d80","pie3":"#8a8f98",
  "pieOuterStrokeWidth":"0px","pieStrokeWidth":"0px",
...
**70% to liquidity.** The pools have to be deep enough to trade against, and that depth is the product.

**25% to the airdrop.** Earned by using the platform rather than claimed by holding something else. Points accrue as you trade, and the airdrop settles against them.
...
Points reward the behaviour the platform needs: volume traded, positions held rather than flipped, and liquidity provided to the pools. Referring someone earns from what they do, on top of the 40% fee share.
